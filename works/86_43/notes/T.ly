...
LXXXVIdTenore = {
  \relative c' {
    ...
    \key c \minor \time 4/4 \tempoLXXXVId \autoBeamOff
      ...
      \markSkip
    \once \override Parentheses.font-size = #3 \parenthesize g4^\markup \remark { "B 1" \critnote } r r \clef "treble_8" \mvTr h8\p^\tuttiE h
    h4 h8 h h4 h8 h
    g4 h r h8 h
    d4 d8 d d4 d8 d
    h4\cresc d r d8 d
